CCVar g_TeleportMode ( "teleport_mode", 0, "Alguna descripción funny", ConCommandFlag::AdminOnly );
...
{
    const string portal_shot_blue = "portal/portalgun_shoot_blue1.wav";
    const string portal_shot_orange = "portal/portalgun_shoot_orange1.wav";
    ...
    const string SoundInvalid = "portal/portal_invalid_surface3.wav";
}
...
class CGPortal : ScriptBasePlayerWeaponEntity
{
    ...
    void PrimaryAttack()
    {
        ...
        ShootPrePortal( m_pPlayer.pev, m_pPlayer.pev.origin + m_pPlayer.pev.view_ofs + g_Engine.v_forward * 0 + g_Engine.v_right * 0 + g_Engine.v_up * 0, g_Engine.v_forward * 1200, 0 );
    ...
    void SecondaryAttack()
    {
        ...
        ShootPrePortal( m_pPlayer.pev, m_pPlayer.pev.origin + m_pPlayer.pev.view_ofs + g_Engine.v_forward * 0 + g_Engine.v_right * 0 + g_Engine.v_up * 0, g_Engine.v_forward * 1200, 1 );
